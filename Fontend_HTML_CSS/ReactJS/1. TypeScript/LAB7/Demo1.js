...
console.log(`Kết quả của calculate(5, 10, minus) là: ${calculate(5, 10, minus)}`); // Kết quả của calculate(5, 10, minus) là: -5
console.log(`Kết quả của calculate(5, 10, multiply) là: ${calculate(5, 10, multiply)}`); // Kết quả của calculate(5, 10, multiply) là: 50
console.log(`Kết quả của calculate(5, 10, divide) là: ${calculate(5, 10, divide)}`); // Kết quả của calculate(5, 10, divide) là: 0.5
